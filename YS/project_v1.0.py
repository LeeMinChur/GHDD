    ...
    if index <3 :
        for i in range(len(menustr)): 
            if( i == index):
                ...
                invert(draw, 80, (i*15)+15, str(order_cnt[i]))
            else:
                draw.text((2, (i*15)+15), menustr[i], font=font, fill=255)
                draw.text((80, (i*15)+15), str(order_cnt[i]), font=font, fill=255)
    else:
        for i in range(index-2,index+1):
            if (i == index):
                menuindex = i
                invert(draw, 2, ((i-(index-2))*15+15), menustr[i])
                invert(draw, 80, ((i-(index-2))*15+15), str(order_cnt[i]))
            elif (i==len(menustr)):
                pass
            else:
                draw.text((2, ((i-(index-2))*15)+15), menustr[i], font=font, fill=255)
                draw.text((80, ((i-(index-2))*15)+15), str(order_cnt[i]), font=font, fill=255)
    ...
    if index <3 :
        for i in range(len(menustr)): 
            if( i == index):
                menuindex = i
                invert(draw, 2, (i*15)+15, menustr[i])
                invert(draw, 70, (i*15)+15, menu_price[i])
            else:
                draw.text((2, (i*15)+15), menustr[i], font=font, fill=255)
                draw.text((70, (i*15)+15), menu_price[i], font=font, fill=255)
    else:
        for i in range(index-2,index+1):
            if (i == index):
                menuindex = i
                invert(draw, 2, ((i-(index-2))*15+15), menustr[i])
                invert(draw, 70, ((i-(index-2))*15+15), menu_price[i])
            elif (i==len(menustr)):
                pass
            else:
                draw.text((2, ((i-(index-2))*15)+15), menustr[i], font=font, fill=255)
                draw.text((70, ((i-(index-2))*15)+15), menu_price[i], font=font, fill=255)          
