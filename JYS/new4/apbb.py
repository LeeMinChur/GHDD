...
class Ui_MainWindow(QMainWindow):
    ...
    # ---------------재료삭제 버튼기능구현함수입니다-------------#
    def ingre_del(self):
        ing_del_layout = QHBoxLayout()
        self.setLayout(ing_del_layout)
        self.setWindowTitle('재료재고 추가')  # 창의 제목
        self.move(300, 300)  # 창의 위치 선정
        self.resize(400, 200)  # 창의 사이즈 조절
        self.label_ing_del_name = QLabel("삭제할 재료", self)
        self.label_ing_del_name.move(25, 25)
        self.txt_ing_del_name = QLineEdit(self)
        self.txt_ing_del_name.move(25 + 100, 22)

        self.btn_ing_del_add = QPushButton("입력", self)
        self.btn_ing_del_add.move(150, 150)
        self.btn_ing_del_add.clicked.connect(self.del_ing)
        self.show()
