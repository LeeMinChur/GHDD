...
from new6.proto1 import *
from new6.sql_and_query import *
...
# class server_log(FigureCanvas):
#     def __init__(self, parent=None, width=7, height=7, dpi=100):
#         print("1")


class server_log(QMainWindow):
    ...
    def guit1(self):
        from new6.proto1 import put_data
        self.j = put_data
