...
from new5.graph import PlotCanvas
from new5.sql_and_query import pysql
import threading
...
class Ui_MainWindow(QMainWindow):
    ...
    def menu_add(self):
        ...
        self.resize(500, 600)  # 창의 사이즈 조절
        self.label_ingname = QLabel("메뉴이름:", self)
        self.label_ingname.move(25,25)
        self.txt_ingname = QLineEdit(self)
        self.txt_ingname.setGeometry(QtCore.QRect(80, 25, 240, 30))


        self.label_ingstock = QLabel("메뉴갯수:", self)
        self.label_ingstock.move(25, 95)
        self.txt_ingstock = QLineEdit(self)
        self.txt_ingstock.setGeometry(QtCore.QRect(80, 93, 240, 30))


        self.btn_ingadd = QPushButton("입력", self)
        self.btn_ingadd.setGeometry(QtCore.QRect(30, 150, 130, 41))


        self.btn_ingadd2 = QPushButton("취소", self)
        self.btn_ingadd2.setGeometry(QtCore.QRect(195, 150, 120, 41))
        self.btn_ingadd2.clicked.connect(QtCore.QCoreApplication.instance().quit)
    ...
    def ingre_add(self):
        print("재료추가버튼기능입니다.")
        self.setWindowTitle('My First Application')  # 창의 제목
        self.resize(350, 210)  # 창의 사이즈 조절
        self.label_ingname = QLabel("재료이름:", self)
        self.label_ingname.move(25,25)
        self.txt_ingname = QLineEdit(self)
        self.txt_ingname.setGeometry(QtCore.QRect(80, 25, 240, 30))


        self.label_ingstock = QLabel("재료갯수:", self)
        self.label_ingstock.move(25, 95)
        self.txt_ingstock = QLineEdit(self)
        self.txt_ingstock.setGeometry(QtCore.QRect(80, 93, 240, 30))
    ...
    def one_month_sales(self):
        ...
        m = PlotCanvas(self, width=7, height=7)
        m.move(0,0)
