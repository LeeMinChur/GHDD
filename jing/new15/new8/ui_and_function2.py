...
from new8.mn_add import mn_add
...
class Ui_MainWindow(QMainWindow,threading.Thread):
    ...
    def setupUi(self, MainWindow):
        ...
        self.pushButton_12.clicked.connect(self.thread_refresh_sell)  # 함수연동문
        ...
        self.tableWidget_3.setGeometry(QtCore.QRect(830, 110, 673, 741))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_12.setText(str("오늘의 주문내역"))
    ...
    # def menu_add(self):
    #     a = threading.Thread(target=self.menu_add2)
    #     a.start()
    ...
    def one_month_sales(self):
        self.ms1 = threading.Thread(target=self.one_month_sales2)
        self.ms1.start()


    def one_month_sales2(self):
    ...
    def one_year_sales(self):
        self.ys1 = threading.Thread(target=self.one_month_sales2)
        self.ys1.start()

    def one_year_sales2(self):
    ...
    def future_predict(self):
        self.fp1 = threading.Thread(target=self.future_predict2)
        self.fp1.start()

    def future_predict2(self):
    ...
    def thread_refresh_all(self):
        a = threading.Thread(target=self.threa)
        a.start()
    ...
    def threa(self):
        while True:
            ...
            if put_data == "주문취소":
                self.thread_refresh_sell()

            elif "," in put_data:
                from new8.server_ms import put_data
                print("--------------#put_data2 : ", put_data)
                self.refresh_all()
    ...
    def thread_refresh_sell(self):
        a = threading.Thread(target=self.refresh_sell)
        a.start()
    ...
    def refresh_sell(self):
        send_menu.resell(self)
        self.tableWidget_3.clearContents()
        self.tableWidget_3.setRowCount(self.salerow)
