...
from new4.menuadd import menu_add_dialog
import threading
...
class Ui_MainWindow(QMainWindow):
    ...
    def menu_add(self):
        ...
        menu_add_dialog().start_menuadd()
        # text, ok = QInputDialog.getInt(self, '매수 수량', '매수 수량을 입력하세요.')
        # if ok:
        #     print("1")


        # self.menu_ins_cursor = self.conn.cursor()
        # ins_menu_sql='''insert into menu values (%s,%s,%s,%s,%s,%s,%s,%s)'''
        # print("이름입력 : ")
        # mn_name=input()
        # print("가격입력 : ")
        # mn_price=input()
        ...
        # mn_stock3 = input()
        #
        # data=(mn_name,mn_price,mn_recipe1,mn_stock1,mn_recipe2,mn_stock2,mn_recipe3,mn_stock3)
        # self.menu_ins_cursor.execute(ins_menu_sql,data)
        #
        # self.conn.commit()
        # print("메뉴입력완료")
